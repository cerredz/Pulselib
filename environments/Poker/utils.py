...
def get_rotated_agents(agents, agent_types, episode_idx=None, q_agent_idx=None):
    n = len(agents)
    q_idx = q_agent_idx if q_agent_idx is not None else agent_types.index(PokerAgentType.QLEARNING)
